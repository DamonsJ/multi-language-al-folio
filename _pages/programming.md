...
title: programming
blog_name2: programming
description2: programming for academics
nav: true
nav_order: 4
pagination:
  enabled: true
...
{% assign blog_name_size = page.blog_name2 | size %}
{% assign blog_description_size = page.description2 | size %}

{% if blog_name_size > 0 or blog_description_size > 0 %}

  <div class="header-bar">
    <h1>{{ page.blog_name2 }}</h1>
    <h2>{{ page.description2 }}</h2>
  </div>
  {% endif %}
